plugins {
    ...
    kotlin("plugin.parcelize") // Add this line for Parcelize

}

android {
    namespace = "com.example.videostoreapplication"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.videostoreapplication"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation ("androidx.lifecycle:lifecycle-livedata-ktx:2.6.1" )// Replace with the latest version
